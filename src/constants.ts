...
export const MIN_DESCRIPTION_LENGTH_ERROR = 'Description should be at least 15 characters long';
...
export const LOCAL_STORAGE_INFO = 'Using 800 MB of Local Storage, upload to cloud to free up space.';
export const UPLOAD_SUCCESS_LOG = 'Started uploading the selected recordings';
export const UPLOAD_FAILURE_LOG = 'Failed to start uploading the selected recordings';
...
export const INITIAL_CONSENT_TEXT = 'By clicking OK, you consent to record all activities on the screen. Please refrain from typing or viewing sensitive/confidential information.';
...
export const VIDEO_CONVERSION_INDICATOR = 'Video conversion in progress... \n This may take several minutes.';
...
export const APP_STATE_HOOK_ERROR = 'useAppState must be used within a AppStateProvider';
